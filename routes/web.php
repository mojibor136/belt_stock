...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(PurchaseController::class)->group(function () {
        ...
        Route::get('/purchase/items/status/{id}', 'status')->name('purchase.status');
        Route::get('/purchase/items/edit/{id}', 'edit')->name('purchase.edit');
        Route::post('/purchase/items/update', 'edit')->name('purchase.edit');
        Route::delete('/purchase/destroy/{id}', 'destroy')->name('purchase.destroy');
    });
