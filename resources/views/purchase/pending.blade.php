...
@section('content')
    ...
    <div class="w-full mb-4">
        ...
        <form action="{{ route('purchase.pending') }}" method="GET"
                        ...
                        <tr class="hover:bg-gray-100 transition-colors cursor-pointer">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span
                                    ...
                                    {{ $purchase->status == 'active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end items-center gap-1">
                                    ...
                                    @php
                                        ...
                                        $statusIcon =
                                            $purchase->status == 'confirm' ? 'ri-check-double-line' : 'ri-refresh-line';
