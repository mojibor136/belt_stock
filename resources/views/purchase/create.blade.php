    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        <div class="flex flex-col bg-white shadow rounded md:p-6 p-4 md:gap-1 gap-3">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Purchase Management</h2>
            ...
            <div class="flex justify-between items-center text-gray-600 text-sm">
                <p>
                    <a href="{{ route('dashboard') }}" class="text-blue-600 hover:underline">Home</a> / Purchase
                    /
                    Create
                </p>
                <a href="{{ route('purchase.index') }}"
            ...
            <form action="{{ route('purchase.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <select id="vendor" name="vendor"
                        class="vendor w-full border border-gray-300 rounded px-3 py-2 text-md focus:ring-1 focus:ring-blue-600 focus:outline-none">
