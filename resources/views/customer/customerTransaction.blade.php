    ...
    <div class="bg-white w-full mb-6 flex flex-col">
        <div
            ...
            <div class="flex flex-col items-center md:items-start gap-1 w-full md:w-1/2">
                <span class="text-3xl font-extrabold text-green-700">{{ $customer->name }}</span>
                <span class="text-gray-600 text-base">Phone: <span class="font-medium">{{ $customer->phone }}</span></span>
            </div>
            <div class="flex flex-col items-center md:items-end gap-1 w-full md:w-1/2 text-gray-700">
                <p class="font-medium text-sm">Address: {{ $customer->address }}</p>
                <p class="font-medium text-sm">Email: {{ $customer->email }}</p>
            </div>
        </div>
