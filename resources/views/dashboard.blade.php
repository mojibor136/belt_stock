    ...
    <div class="flex flex-col">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-3">
            ...
            <a href="#"
                ...
                <div class="text-2xl font-bold text-yellow-600">40</div>
            ...
            <a href="#"
                ...
                <div class="text-2xl font-bold text-emerald-600">12000</div>
            ...
            <a href="#"
                ...
                <div class="text-2xl font-bold text-orange-600">150000</div>
            ...
            <a href="#"
                ...
                <div class="text-2xl font-bold text-rose-600">8</div>
            ...
            <a href="#"
                ...
                <div class="text-2xl font-bold text-teal-600">350</div>
            ...
            <a href="#"
                ...
                <div class="text-sm text-gray-500 capitalize">Low Stock Items</div>
                <div class="w-full h-2 rounded-md bg-red-600 mt-3 bg-opacity-30">
                    <div class="h-2 rounded-md bg-red-600 progress-bar-inner" style="--progress-width: 100%;"></div>
                </div>
            </a>
