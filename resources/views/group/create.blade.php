    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        <div class="flex flex-col bg-white shadow rounded md:p-6 p-4 md:gap-1 gap-3">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Group</h2>
        ...
        <div class="w-full bg-white rounded shadow px-6">
            <form action="{{ route('groups.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    <label for="cost_rate" class="block text-md font-medium text-gray-700 mb-1.5">
                ...
                <div class="mt-4">
                    <label for="sales_rate" class="block text-md font-medium text-gray-700 mb-1.5">
