    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        <div class="flex flex-col bg-white shadow rounded md:p-6 p-4 md:gap-1 gap-3">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Size</h2>
            ...
            <div class="flex justify-between items-center text-gray-600 text-sm">
                <p>
                    <a href="{{ route('dashboard') }}" class="text-blue-600 hover:underline">Home</a> / Size / Create
                </p>
                <a href="{{ route('sizes.index') }}"
        ...
        <div class="w-full bg-white rounded shadow px-6">
            <form action="{{ route('sizes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <input type="number" id="size" name="size" placeholder="Enter Sizes"
                ...
                <div class="mt-4">
                    <label for="rate_type" class="block text-md font-medium text-gray-700 mb-1.5">
